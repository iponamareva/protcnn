...
def make_dataset(X, y, batch_size=28):
...
def expand_sparse_activations_from_df(df, n_classes=nclasses, alpha=0.125):
...
def preprocess_dfs(mode="train", max_length=180, alpha=1.0):
